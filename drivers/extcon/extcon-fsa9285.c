...
static void usb_plug_out_otg_vbus(struct fsa9285_chip *chip)
{
   ...
   mdelay(10); //liulc1
    ...
    fsa9285_write_reg(client, 0x6, 0x4C);
...
static void get_id(struct fsa9285_chip *chip)
{
    ...
    // ADC always ON
    fsa9285_write_reg(client, 0x7, 0x4);
    // ID read
    id = fsa9285_read_reg(client, 0x3);
    // ADC normal
    fsa9285_write_reg(client, 0x7, 0x0);
...
__initcall(fsa9285_extcon_early_init);
